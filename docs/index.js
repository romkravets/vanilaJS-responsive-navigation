...
var _NavMenu = __webpack_require__(330);

var _MainSection = __webpack_require__(332);
...
var firstDataSection = [{
   titleSection: "Responsive Navigation",
   description: "Simple vanilla JavaScript.",
   buttonText: "Call me"
}];

var secondDataSection = [{
   titleSection: "Second Section Daynemic JS",
   description: "Vanilla JavaScript Section. Dynemic change description",
   buttonText: "Call me"
}];

new _NavMenu.NavMenu(document.querySelector('#navigation'), navLinks);
new _MainSection.MainSection(document.querySelector('#firstSection'), firstDataSection);
new _MainSection.MainSection(document.querySelector('#secondSection'), secondDataSection);
...
var NavMenu = exports.NavMenu = function () {
   function NavMenu(rootElenent, options) {
...
var MainSection = exports.MainSection = function () {
   function MainSection(rootSection, dataSection) {
